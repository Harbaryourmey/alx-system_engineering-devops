...
8-cwd_state: It writes into the file ls_cwd_content the result of the command ls -la.
...
101-gifs: To lists all the files with a .gif extension in the current directory and all its sub-directories.
